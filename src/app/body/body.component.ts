...
export class BodyComponent implements OnInit {
  ...
  lma = [{name: '0001 BRITISH COLUMBIA'},{name: '0002 CALGARY/LATHBRIDGE/MEDICINE HAT/RED DEER'},{name: '0003 EDMONTON/LLOYDMINISTER/DAWSON CREEK'},{name: '0004 SASKATCHEWAN'},{name: '0005 MANITOBA'},{name: '0006 THUNDER BAY/KENORA'},{name: '0007 SUDBURY/SAULT STE.MARIE/TIMMINS/NORTH BAY'}];
  lmaSltd = [];
